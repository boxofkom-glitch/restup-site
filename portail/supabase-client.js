...
async function restupStaffBar(me) {
  ...
  style.textContent = `
    ...
    @media (max-width:900px){
      ...
      .main{position:fixed;inset:0;height:auto;display:flex;flex-direction:column;overflow:hidden;min-width:0}
      .main>.tab-nav{flex:0 0 auto}
      .main>.admin-main{flex:1;min-height:0;overflow-y:auto;overflow-x:hidden;-webkit-overflow-scrolling:touch;overscroll-behavior:contain;padding:12px 14px calc(70px + env(safe-area-inset-bottom,0px)) !important;max-width:none}
